...
const test = async () => {
  ...
  execSync("npm create octobox-app -- argumented internal --path octoboxtestapp --tailwind FALSE --eslint FALSE --stylelint FALSE --custom_fallbacks FALSE --recommended_windows FALSE");
...
`);
  ...
  child.on("close", async (close) => {
    ...
    execSync("npm create octobox-app -- argumented internal --path octoboxtestapptwo --tailwind TRUE --eslint TRUE --stylelint TRUE --recommended_eslint_config FALSE --recommended_stylelint_config FALSE  --recommended_windows TRUE --custom_fallbacks TRUE --basename custom --unresponsive_ms 250 --pending_ms 500 --max_age_ms 10000");
