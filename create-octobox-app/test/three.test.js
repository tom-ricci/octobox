...
const test = async () => {
  ...
  execSync("npm create octobox-app -- argumented internal --path sassyoctoboxtestapp --tailwind FALSE --eslint FALSE --stylelint FALSE --recommended_eslint_config FALSE --recommended_stylelint_config FALSE");
