...
const Index: FC<Props> = (): ReactElement => {
  ...
  return (
    <React.Fragment>
      <h1>This is a long page designed to show how Octobox scrolls to the top of the page.</h1>
      <p>
      ...
      <button onClick={restoreScroll}>Scroll up</button>
      <Link to={"../"}>Go home and scroll up</Link>
    </React.Fragment>
  );
};
